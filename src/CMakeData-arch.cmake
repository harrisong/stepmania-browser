...
elseif(EMSCRIPTEN OR EMSCRIPTEN_BUILD)
  # Use stub threading for single-threaded Emscripten
  list(APPEND SMDATA_ARCH_THREADS_HPP "arch/Threads/Threads_Null.h")
  list(APPEND SMDATA_ARCH_THREADS_SRC "arch/Threads/Threads_Null.cpp")
  message(STATUS "Using Threads_Null for single-threaded Emscripten")
else()
  if(HAS_PTHREAD)
    list(APPEND SMDATA_ARCH_THREADS_HPP "arch/Threads/Threads_Pthreads.h")
    list(APPEND SMDATA_ARCH_THREADS_SRC "arch/Threads/Threads_Pthreads.cpp")
...
if(EMSCRIPTEN OR EMSCRIPTEN_BUILD)
...
elseif(EMSCRIPTEN OR EMSCRIPTEN_BUILD)
  ...
  message(STATUS "Using LowLevelWindow_SDL for Emscripten")
elseif(UNIX)
  if(X11_FOUND)
    list(APPEND SMDATA_ARCH_LOWLEVEL_SRC
...
if(EMSCRIPTEN OR EMSCRIPTEN_BUILD)
  ...
  message(STATUS "Using InputHandler_SDL for Emscripten")
endif()
...
if(NOT APPLE)
  ...
  elseif(EMSCRIPTEN OR EMSCRIPTEN_BUILD)
    list(APPEND SMDATA_ARCH_HOOKS_SRC "arch/ArchHooks/ArchHooks_Emscripten.cpp")
    list(APPEND SMDATA_ARCH_HOOKS_HPP "arch/ArchHooks/ArchHooks_Emscripten.h")
    message(STATUS "Using ArchHooks_Emscripten for browser")
  else()
